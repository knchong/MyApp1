...
public class Timer1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        StartPause.setOnClickListener(new View.OnClickListener() {
            @Override //start/pause for on click start button
    ...
    private void startTimer(){
        CountDownTimer = new CountDownTimer(TimeLeft, 1000) {
            ...
            public void onTick(long millisUntilFinished) {
                TimeLeft = millisUntilFinished;//update the timer to latest
                updateCountDown();
            }
            @Override
    ...
    private void updateCountDown(){
        int minutes = (int) (TimeLeft/1000)/60;//calculate minutes
        int seconds = (int) (TimeLeft/1000)%60;//calculate seconds
